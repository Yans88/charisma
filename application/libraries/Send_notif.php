...

{
	...
	public function send_email($from=null,$pass=null, $to=null,$subject=null, $body=null,$_cc=0){
		...
		$this->ci->email->from($from, 'Charisma');
		$this->ci->email->to($to);
		$this->ci->email->subject($subject);
		$this->ci->email->message($body);
		if($_cc > 0){
			$this->ci->email->cc('bernard@andtechnology.mobi,dzakyrifqiatha@gmail.com,charismakuonline@gmail.com,yansen@andtechnology.mobi');
		}
