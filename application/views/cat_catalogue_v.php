...
<div class='alert alert-info alert-dismissable' id="success-alert">
	...
	<table id="example88" class="table table-bordered table-striped">
		<thead><tr>
			...
			<th style="text-align:center; width:55%">Kategori</th>			
...
$('.yes_del').click(function(){
	var id = $('#del_id').val();
	var url = '<?php echo site_url('catalogue/categories_del');?>';
	$.ajax({
		data : {id : id},
		url : url,
		type : "POST",
...
$('.yes_save').click(function(){
	...
	var url = '<?php echo site_url('catalogue/simpan_cat_catalogue');?>';
...
$(function() {
	var path_role= '<?php echo site_url('catalogue/categories_data');?>';
