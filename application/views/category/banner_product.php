			...
			<?php 
				...
				if(!empty($category)){		
					foreach($category as $c){	
						$view_sub = '';
						$path = !empty($c['img']) ? base_url('uploads/kategori/products/'.$c['img']) : base_url('uploads/no_photo.jpg');
...
$('.yes_del').click(function(){
	var id = $('#del_id').val();
	var url = '<?php echo site_url('category/del_img');?>';
	$.ajax({
		data : {id : id},
		url : url,
		type : "POST",
...
$('.yes_save').click(function(){
	...
	var url = '<?php echo site_url('category/simpan_img');?>';
