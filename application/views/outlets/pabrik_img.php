			...
			<?php 
				...
				if(!empty($category)){		
					foreach($category as $c){	
						$view_sub = '';
						$path = !empty($c['img']) ? base_url('uploads/pabrik/'.$c['img']) : base_url('uploads/no_photo.jpg');
...
$('.yes_del').click(function(){
	var id = $('#del_id').val();
	var url = '<?php echo site_url('outlet/del_img');?>';
	$.ajax({
		data : {id : id},
		url : url,
		type : "POST",
...
$('.yes_save').click(function(){
	...
	var url = '<?php echo site_url('outlet/simpan_img');?>';
