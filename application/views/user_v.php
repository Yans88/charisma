          ...
          <div class="modal-dialog" style="width:600px">
            <div class="modal-content">
              ...
              <div class="modal-body" style="padding-bottom:2px;">
				...
				<div class="form-group">
                  <label>Confirm Password</label><span class="label label-danger pull-right conf_password_error"></span>
                  <input type="password" class="form-control" name="conf_password" value="" id="conf_password" placeholder="Confirm Password" autocomplete="off" />
                </div>
	...
	<table id="example88" class="table table-bordered table-striped">
		...
		<tbody>
			<?php 
				...
				if(!empty($users)){
					foreach($users as $u){	
						$info = $u['operator_id'].'Þ'.ucwords($this->converter->decode($u['username'])).'Þ'.$u['fullname'].'Þ'.$u['status'].'Þ'.$u['email'];
